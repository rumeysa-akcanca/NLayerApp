...
namespace NLayer.Repository.Migrations
{
    ...
    [Migration("20220828111802_InitialCreateHome")]
            ...
            modelBuilder.Entity("NLayer.Core.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CaategoryId = 1,
                            CreatedDate = new DateTime(2022, 8, 28, 14, 18, 2, 339, DateTimeKind.Local).AddTicks(7525),
                            Name = "Kalem1",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 2,
                            CaategoryId = 1,
                            CreatedDate = new DateTime(2022, 8, 28, 14, 18, 2, 339, DateTimeKind.Local).AddTicks(7536),
                            Name = "Kalem2",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 3,
                            CaategoryId = 1,
                            CreatedDate = new DateTime(2022, 8, 28, 14, 18, 2, 339, DateTimeKind.Local).AddTicks(7537),
                            Name = "Kalem3",
                            Price = 100m,
                            Stock = 20
                        },
                        new
                        {
                            Id = 4,
                            CaategoryId = 2,
                            CreatedDate = new DateTime(2022, 8, 28, 14, 18, 2, 339, DateTimeKind.Local).AddTicks(7538),
                            Name = "Kitap1",
                            Price = 200m,
                            Stock = 30
                        },
